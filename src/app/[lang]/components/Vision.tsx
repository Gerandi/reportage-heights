  ...
  return (
    <section id="vision" className="bg-white w-full" style={{ contentVisibility: 'auto' }}>
      ...
      <div className="lg:hidden flex flex-col gap-[40px] px-[20px] pb-[29px] pt-[45px]">
        ...
        {/* Image card with tower badge at bottom */}
        <div className="relative bg-[#f5f5f5] h-[400px] rounded-[8px] overflow-hidden flex items-end p-[24px]">
      ...
      <div className="hidden lg:flex gap-[80px] items-center justify-center px-[80px] py-[140px]">
        ...
        <div className="relative w-[654px] h-[650px] shrink-0">
          <div className="relative w-full h-full rounded-[12px] overflow-hidden shadow-[0px_40px_100px_0px_rgba(66,82,99,0.2)]">
            {/* Keep as img — intentional h-[134%]/top-[-26%] parallax overflow */}
            ...
            <div className="absolute inset-0 bg-[rgba(0,0,0,0.24)] rounded-[8px] flex items-center justify-center">
              <div className="bg-[rgba(255,255,255,0.13)] flex items-center justify-center rounded-[100px] size-[123px] p-[11px]">
