...
export default function Experience({ dict }: { dict: Dictionary }) {
  ...
  const mobileApartments = [
    { title: t.type1Title, img: MOBILE_IMG_1BED },
    { title: t.type2Title, img: MOBILE_IMG_STUDIO },
    { title: t.type3Title, img: MOBILE_IMG_1BED },
  ]

  const desktopApartments = [
    { badge: t.type1Badge, title: t.type1Title, img: IMG_1BED, total: t.type1Total, internal: t.type1Internal, balcony: t.type1Balcony },
    { badge: t.type2Badge, title: t.type2Title, img: IMG_STUDIO, total: t.type2Total, internal: t.type2Internal, balcony: t.type2Balcony },
    { badge: t.type3Badge, title: t.type3Title, img: IMG_1BED, total: t.type3Total, internal: t.type3Internal, balcony: t.type3Balcony },
  ]
          ...
          {mobileApartments.map((apt) => (
            <div key={apt.title} className="bg-[rgba(0,0,0,0.2)] border border-[rgba(216,210,196,0.2)] flex flex-col rounded-[6px] overflow-hidden">
              ...
              <div className="bg-[#e8e7e6] flex flex-col gap-[24px] items-start p-[24px]">
                ...
                <button className="bg-[#e6b867] flex items-center justify-center gap-[12px] h-[52px] w-full rounded-[4px]">
            ...
            <div key={apt.title} className="flex-1 flex flex-col bg-[rgba(216,210,196,0.05)] border border-[rgba(216,210,196,0.1)] rounded-[12px] overflow-hidden">
              <div className="relative h-[350px] w-full shrink-0">
                ...
                <div className="absolute inset-0 bg-[rgba(66,82,99,0.3)] flex items-center justify-center">
                  <button className="flex items-center gap-[12px] bg-[#e6b867] px-[32px] py-[16px] rounded-[4px] shadow-[0px_20px_40px_0px_rgba(0,0,0,0.3)]">
